...
export const TVChart = ({
  ...
  const [lastChartValues, setLastChartValues] = useState<{
    time: any;
    res: any;
  }>({ time: null, res: null });
    ...
    if (widget) {
      widget.onChartReady(() => {
        widget.applyOverrides({
          ...
          "paneProperties.background": "#111214", // Chart background color
        ...
        widget.chart().getSeries().setChartStyleProperties(1, {
          upColor: "#00F3E7",
          downColor: "#D82C60",
          borderUpColor: "#00F3E7",
          borderDownColor: "#D82C60",
        });

        widget.subscribe("drawing_event", () => {
          widget.save((state: any) => {
            localStorage.setItem(
              "tradingViewDrawingState",
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={cn(
          "min-h-[500px] h-full w-full overflow-hidden rounded-md object-cover",
