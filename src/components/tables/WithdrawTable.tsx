...
export default function WithdrawTable(props: WithdrawProps) {
  const WithdrawSkeletonRow = () => {
    return (
  ...
  return (
    <div className="withdrawTable flex flex-col w-full min-w-max">
          ...
          props.data?.map((item) => (
            <>
              <div className="row py-2 md:py-4">
                ...
                <div className="flex items-center gap-2">
                  <span>{shortenAddress(item.toMint)}</span>
                </div>
