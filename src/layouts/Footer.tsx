      ...
      <div className="flex flex-col">
        <div className="flex flex-col gap-6">
          <div className="flex items-center gap-4">
            ...
            <span className="futura text-[40px] font-bold">GMI</span>
          </div>
          <span className="text-gray font-medium">
            ©2024 GMI All Rights Reserved
          </span>
          <div className="flex items-center gap-5">
            <div className="flex gap-3">
              <Link
                to=""
                className="flex justify-center items-center border rounded-md w-7 h-7"
                target="_blank"
              >
      ...
      <div className="grid grid-cols-[160px_360px] gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex border border-light-gray rounded-lg">
            <input
              className="bg-transparent outline-none mx-2 flex-grow"
              placeholder="Email Address"
            />
            <Button className="primary font-bold text-xl">{"->"}</Button>
          </div>
          <span className="text-sm text-gray">
            Subscribe to our newsletter to receive relevant information on the
            GMI.
          </span>
        </div>
      </div>
