  ...
  return (
    <div className="flex flex-col gap-4 w-full mt-[20px] common-bg">
      <div className="flex flex-col gap-2">
        <span className="text-2xl font-bold">Memescope</span>
      ...
      <div className="flex justify-between">
        <div className="grid md:grid-cols-[200px_120px_120px_1fr] w-full gap-2">
          <div className="flex border border-outline bg-[#FFFFFF10] rounded-full items-center justify-center gap-2 text-gray">
            <Button className={`text-soft-white`}>5m</Button>
            <Button className={``}>1h</Button>
            <Button className={``}>6h</Button>
            <Button className={``}>24h</Button>
          </div>
      ...
      <div className="flex">{/* <PairTable /> */}</div>
    </div>
  );
}
