...
import OrderTable from "../../components/tables/AllOrdersTable";
import { useAccountInfo } from "../../providers/AppContext";
import { ILimitOrder, IOrderFilter } from "../../interface";
...
export default function Order() {
  ...
  } = useInfiniteOrdersHistory(20, filters);
      ...
      <div className="flex flex-col gap-5 min-h-56 rounded-xl">
        {!data?.length ? (
          ...
          <div className="w-full overflow-auto">
            <OrderTable data={data} refetch={orderRefretch} />
          </div>
        )}
      </div>
    </div>
