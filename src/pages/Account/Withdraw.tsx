  ...
  return (
    <div className={`flex flex-col gap-4 py-4`}>
      <span className="text-sm text-gray font-semibold">
        Withdraw from your GMI trading wallet to your chosen wallet.
      </span>
      <div className="flex flex-col md:flex-row gap-4 items-center">
        <div className="flex flex-col gap-2 w-full md:w-fit">
          <span className="font-bold">Withdraw from</span>
          <div className="flex items-center gap-1 border border-outline bg-[#FFFFFF10] px-4 py-2 rounded-lg">
        ...
        <div className="flex flex-col gap-2 w-full md:w-fit">
          ...
          <div className="flex items-center gap-1 border border-outline bg-[#FFFFFF10] px-4 py-2 rounded-lg">
            <span className="text-sm w-full overflow-hidden text-ellipsis">
              {userInfo?.wallet}
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2 items-end w-full md:w-fit">
          ...
          <Button className="primary w-full" onClick={handleWithdraw}>
            Withdraw
          </Button>
        </div>
      </div>
